...
(function() {
  var GL, S3, allofw, allofwutils, cubes, data, i, j, k, l, m, n, nav, omni, ref, ref1, ref2, ref3, ref4, ref5, render, size, t0, timer, w;
  ...
  cubes = S3.cubes().attr("vec3", "center", "v1").attr("vec3", "size", "vec3(0.2, 0.2, 0.2)").variable("vec3", "v1", function(d) {
    return [d.x, d.y, d.z];
